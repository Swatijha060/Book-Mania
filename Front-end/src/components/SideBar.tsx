  ...
  return (
    <div className="bg-black text-white w-1/5 min-w-[200px] min-h-screen sticky p-6 flex flex-col">
      ...
      <nav>
        ...
        <Link to="/genre" className="flex items-center mb-6 text-lg hover:text-[#A85C5C]">
          <FaBook className="mr-4" /> Genre
        </Link>
        <Link to="/mylibrary" className="flex items-center mb-6 text-lg hover:text-[#A85C5C]">
          <FaBook className="mr-4" /> My Library
        </Link>
        <Link to="/settings" className="flex items-center text-lg hover:text-[#A85C5C]">
